        ...
        <div>
            ...
            <section className='NotaConteiner' >
                <div className='NotaTexConteiner'>
                    ...
                    <p>
                        Medí a tu perro con una cinta métrica. Tené en cuenta que la casita debe tener una altura 25% mayor que la altura de tu perro. Una medida estándar para perros medianos sería 60 cm de ancho x 60 cm de alto x 80 cm de largo. Marcá las medidas sobre la placa de OSB.
                    </p>
                    <p>
                        <strong>Paso 2: corte de las piezas</strong>
                    </p>
                    <p>
                        <p>Con la sierra eléctrica, cortá las siguientes piezas de la placa de OSB:</p>
                        ...
                        Un techo inclinado: cortá dos piezas rectangulares de 80 cm de largo x 50 cm de ancho. Uní estas dos piezas en ángulo para formar el techo inclinado.
                    </p>
                    ...
                    <p>
                        Lijá los bordes de todas las piezas para eliminar las astillas.
                    </p>
                    ...
                    <p>
                        ...
                        Colocá la base en el suelo. Tomá una de las paredes laterales y ponela verticalmente sobre la base, alineando el borde inferior de la pared con el borde de la base.
                        Fijá la pared lateral a la base con tornillos, asegurándote de que esté completamente perpendicular. Usá al menos 4 tornillos distribuidos a lo largo del borde para darle estabilidad. Repetí el mismo proceso con la otra pared lateral.
                    </p>

                    <p>
                        <u>Pared trasera</u><br />
                        Tomá la pieza trasera y colocala al borde posterior de la base, alineándola con los bordes de las dos paredes laterales. Fijá la pared trasera a las paredes laterales usando tornillos. Asegurate de usar tornillos a lo largo de los bordes laterales para asegurar la conexión firme. Después, atornillá la parte inferior de la pared trasera a la base.
                    </p>

                    <p>
                        <u>Pared frontal</u><br />
                        Colocala en el borde delantero de la base. Antes de fijarla, asegurate de que la entrada ya esté cortada. La entrada debe estar centrada en la pieza frontal y la parte inferior debe estar cerca del borde inferior de la pared para que el perro pueda entrar fácilmente. Fijá la pared frontal de la misma manera que la trasera, asegurándola con tornillos a las paredes laterales y a la base.
                    </p>

                    <p>
                        <u>Techo inclinado</u><br />
                        Tomá las dos piezas que cortaste para el techo. Estas dos piezas formarán un techo a dos aguas (con pendiente) para que el agua de lluvia escurra y no arruine la madera.
                        Colocá una de las piezas sobre la estructura, alineando su borde con la parte trasera de la casita, dejando que sobresalga ligeramente por los lados. Fijá esta pieza con tornillos a las paredes laterales y frontal.
                        Poné la segunda pieza del techo de manera similar, superponiéndola ligeramente con la primera pieza en la parte superior (formando el ángulo de inclinación). Asegurala también con tornillos a los laterales y frontal.
                        Ahora bien, si preferís un techo removible, tendrás que usar bisagras en uno de los lados para que puedas levantarlo y limpiarlo fácilmente.
                    </p>
                    ...
                    <p>
                        Podés añadir bisagras si querés que el techo sea removible para facilitar la limpieza.
                        Por otra parte, para proteger la casita de la lluvia, el sol y la humedad, aplicá una capa de barniz en toda la estructura, especialmente en el techo y las partes que estarán expuestas al agua. Esto ayudará a prolongar la vida útil de la madera.
                        Ahora bien, si querés decorarla, podés pintar la casita con pintura exterior resistente a la intemperie. Aplicá al menos dos capas de pintura o barniz, dejando secar entre cada aplicación según las instrucciones del producto.
                    </p>

                    <p>
                        <u>Opcional: Aislamiento</u><br />
                        Si la casita estará en una zona con temperaturas frías, podés añadir una capa de aislante térmico (como espuma o paneles de poliestireno) en el interior de las paredes antes de fijar el techo. Esto ayudará a mantener la casita más calentita.
                    </p>
                    <p>
